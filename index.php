...
arsort($filtered_lvl);
$lvl5 = array_slice($filtered_lvl, 0, 3);
                ...
                <div class="product-top-bar customize-tab-bar">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li role="presentation" ><a href="#p-bestseller" data-toggle="tab"><i
                                        class="fa fa-pencil-square-o"></i>Most Visited Products</a></li>
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="muster-product">
                <div class="row tab-content-row">
                    ...
                    $sql1 = "SELECT * FROM `Product`WHERE ProductId > "  . $id * 1000 .  " and ProductId <  ". ($id + 1) * 1000 .  " LIMIT 5";
                    if($connection){
