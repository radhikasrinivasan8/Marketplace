...
<div class="container">
    <div class="col-md-6">
        <h3> Tracking the last 3 Companies visited</h3>
        <hr>
        <?php
  ...
  <strong>Do you want more portrait photographs? </strong>  Please check out <a href='http://viewyourthoughts.com'>Blizzard Studio</a> 
                    ...
                    echo "<div class=\"alert alert-info\" role=\"alert\">
  <strong>You seem to have a penchant for Apparels!</strong>  Please check out <a href='http://absolutestop.com/'>Absolute Stop</a> 
</div>";
                }
